  ...
  return (
    <>
      ...
      <div className="navbar bg-primary text-primary-content">
        ...
        <div className="navbar-end pr-5 items-center">
          <ul className="menu menu-horizontal items-center gap-3 px-1 hidden sm:flex">
            {user ? (
              <>
                <li>
                ...
                <li>
                  <a onClick={() => navigate("/workouts")}>My Workouts</a>
                </li>
                <li>
